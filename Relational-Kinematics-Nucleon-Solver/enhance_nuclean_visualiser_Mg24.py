...
positions = np.array([
    [ 1.139,  1.285,  0.493],  # Entity 0 (alpha)
    [-1.369, -2.784,  2.393],  # Entity 1 (alpha)
    [-3.427,  1.398,  1.452],  # Entity 2 (alpha)
    [-2.177,  2.124, -0.488],  # Entity 3 (alpha)
    [ 1.138, -2.731, -1.379],  # Entity 4 (alpha)
    [ 1.222, -0.803,  0.576]   # Entity 5 (alpha)
])

spins = np.array([
    [ 0.010, -0.039,  0.999],  # Vector 0
    [ 0.296,  0.476,  0.828],  # Vector 1
    [-0.120,  0.178,  0.977],  # Vector 2
    [ 0.144, -0.149,  0.978],  # Vector 3
    [ 0.244,  0.069,  0.967],  # Vector 4
    [-0.159, -0.392,  0.906]   # Vector 5
])
