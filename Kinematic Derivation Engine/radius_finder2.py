...
# --- Engine Parameters (TUNED FOR CRITICAL DAMPING) ---
dt = 0.01           # SMALLER TIME-STEP for smoother wave resolution
kappa = 0.5         # LOWER restoring force (gentler pressure spikes)
gamma = 2.0         # HIGHER substrate viscosity (faster energy bleed)
iterations = 3000   # More loops to allow for the slower settling
...
for i in range(iterations):
    ...
    # The pressure gradient adjusts, heavily damped by gamma
