...
if __name__ == "__main__":
    # Instantiating the same baseline high-torque core profile
    ...
    # Render the X-Z slice cross-section
    engine.render_slice(x_bounds=(-2.5, 2.5), z_bounds=(-2.5, 2.5), res=150)